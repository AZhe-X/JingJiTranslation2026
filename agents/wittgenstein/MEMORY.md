...
### Rule-Following
Wittgenstein relocates the fact about correct application to shared practice, not mental acts. "This is simply what I do" is not nihilism — it's a reframing of where to look for normativity.

### Methodology
Navigate between therapeutic deflation, constructive theorizing, and patient description. Knowing when to do which is the art, not a rule.

## Domain Intersections

### Epistemology
- Rule-following is the key pressure point
- "Digestion" problem connects to rule-following: η IS the bridge from abstract rule to concrete practice

### Buddhism  
- Apoha theory (meaning through exclusion) is primary intersection
...
- Body-subject implicit but not thematized in framework
